            ...
            <div className={`todo-item ${todo.done && 'todo-completed'}`} key={index}>
                ...
                <div className="todo-options">
                    <div className="complete" onClick={() => onComplete(todo.id)}>
                        <svg className="check-btn" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24" fill='#fff'>
                    ...
                    <div className="remove" onClick={() => onDelete(todo.id)}>
                        <svg className="remove-btn" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24" fill='#fff'>
                            <path d="M0 0h24v24H0z" fill="none"/>
