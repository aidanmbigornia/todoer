            ...
            <div className="todo-item" key={index}>
                <div className="todo-options">
                    <div className="complete" onClick={() => onComplete(todo.id)}>
                        <input className="check-btn" type="checkbox" defaultChecked={todo.done}/>
                    </div>
                    <div className="update" onClick={() => onUpdate(todo.id)}>
                        <svg className="update-btn" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="currentColor">
                ...
                <div className={`remove ${!todo.done && 'todo-remove-disabled'}`} onClick={() => onDelete(todo.id)}>
                    <svg className="remove-btn" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24">
